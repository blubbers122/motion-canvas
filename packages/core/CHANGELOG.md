...
* **2d:** support tweening emojis ([#1085](https://github.com/motion-canvas/motion-canvas/issues/1085)) ([03d41b1](https://github.com/motion-canvas/motion-canvas/commit/03d41b1ed9de8c2f40126a21d277033ac5408b00)), closes [#1066](https://github.com/motion-canvas/motion-canvas/issues/1066)
* **core:** always show both scenes when seeking mid-transition ([#1128](https://github.com/motion-canvas/motion-canvas/issues/1128)) ([dfb4f9b](https://github.com/motion-canvas/motion-canvas/commit/dfb4f9b4291430a797526e4a8e9545ee49ce963f))
* **core:** fix AudioManager.isInRange logic ([#1156](https://github.com/motion-canvas/motion-canvas/issues/1156)) ([8e76124](https://github.com/motion-canvas/motion-canvas/commit/8e761249c19dce4d3b16b47505645dfe09c30a05))
* **core:** fix incorrect rollup ordering ([2ae47a6](https://github.com/motion-canvas/motion-canvas/commit/2ae47a63e9b74e2726b5485951d03ccc0ceb8541))
* **core:** force valid chroma-js version ([#1086](https://github.com/motion-canvas/motion-canvas/issues/1086)) ([3a23b57](https://github.com/motion-canvas/motion-canvas/commit/3a23b57b5a56e691c13c1ba7ea5744414f1d20dc))
* explicitly type Vector2.toArray() to return a tuple ([#1107](https://github.com/motion-canvas/motion-canvas/issues/1107)) ([c3c85d5](https://github.com/motion-canvas/motion-canvas/commit/c3c85d5a6c9cabcd372f07cf0860a95197487833))
...
* **core:** add BBox.translate ([#1164](https://github.com/motion-canvas/motion-canvas/issues/1164)) ([aa54e99](https://github.com/motion-canvas/motion-canvas/commit/aa54e99e424ec9c31348027d7fd5d4a0fc656f99))
